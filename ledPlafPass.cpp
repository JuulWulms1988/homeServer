...
void mainThreadCls::clsExMes::strExec::sendLedPl(unsigned __int8 ad) {
...
void mainThreadCls::clsLedPl::clsLedPlObj::passPrep(strSndV s, strMpCh& pMCh, unsigned __int8 ad) {
...
void mainThreadCls::trLisHomeCls::chSerAggPl(unsigned __int8 adrB) {
...
void mainThreadCls::clsLedPl::clsLedPlObj::flagPsMsPr() {
	{
		unique_lock<mutex> lk(cvPsMs.mut); if (!cvPsMs.ready) cvPsMs.cv.wait(lk, [&] { return cvPsMs.ready; });
		cvPsMs.ready = false;
	} threadBufCls::recStruct{ p_ledPl.threadMut, [](void * p, void* U) { ((clsLedPlObj*)p)->flagPsMs();} }.start(this, NULL);
}

void mainThreadCls::stSndStt::ledPlF(char* ls, __int8 lsNow, unsigned __int8 strAd) {
...
void mainThreadCls::clsLedPl::clsLedPlObj::voegFrCons(strSndV &s, unsigned __int8 ad) {
...
void mainThreadCls::clsExMes::strExec::voegLedPlaf(unsigned __int8 ad) {
